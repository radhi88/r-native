...
(Changed 2026-06-16 — previously trailed every magic, which was hijacking the user's
gold trades at small profit; he asked to take bigger profits, this was the cause.)
...
# 🛑 لا تُدِر صفقات المستخدم — اتركه يركب أرباحه بنفسه. نُدير بوتات R Native فقط.
# magic 0 = يدوي المستخدم/أداة خارجية · 20250421/22 = إكسبيرت QuantumShark تبعه (له trailing خاص).
# (طلب المستخدم 2026-06-16: "ليه يقفل بسرعة... خلنا ناخذ أرباح أكبر" — كان هذا المحرّك السبب.)
