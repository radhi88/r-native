...
# Account-level risk
ACCOUNT_RISK = {
    # Raised 15→25% on 2026-05-30 by explicit user authorization so BTC can trade
    # the weekend after an -$84 FX/metals day tripped the 15% cap. Higher ceiling =
    # less protection after a losing day — kept deliberately bounded (not removed).
    "daily_loss_pct":    25.0,   # stop trading after -25% day (user-raised)
