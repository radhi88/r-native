...
Runs in its own process every 2s. Operates on EVERY open position
regardless of magic — so it protects bots AND any pending user
positions that don't already have a trail.
